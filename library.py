# This contains the Library class and all the functions of the Library Management System
...
class Library():
    ...
    def add_book(self):
        ...
        publication_date = input(f"What is the publication date for '{title}'?: ")
        new_book = Book(title, author, isbn, genre, publication_date)

        self.books.append(new_book)
        print(f"\nYou have added '{title}' to the Library!")
    ...
    def return_book(self, title):
        ...
        user = input(f"Who is the user returning {title}?: ")
        no_user = True
        for i in self.users:
            if user == i.get_name():
                no_user = False
            ...
            if no_user:
                print(f"Sorry {i.get_name()} is not a library member.")
        else:
            print(f"The book {title} does not exist in the library.")
    ...
    def author_details(self):
        if not self.authors:
            ...
            for i in self.authors:
                print(f"Name: {i.name}, Biograpy: {i.biography}")

    def display_authors(self):
        if not self.authors:
            print("Sorry there are no authors in the list!")
        else:
            print("Here are the authors in the list!")
            for i in self.authors:
                print(f"{i.get_name()}")
